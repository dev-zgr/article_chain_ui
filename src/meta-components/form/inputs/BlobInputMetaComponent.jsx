        ...
        <div className="col-span-full">
            ...
            <div className="mt-2">
                <textarea id="about" name={name} rows="3" value={inputValue} onChange={onChangeHandler}  {...rest}
                          className="block w-full font-medium rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-sky-800 sm:text-sm sm:leading-6"></textarea>
            </div>
